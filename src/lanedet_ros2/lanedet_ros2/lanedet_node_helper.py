...
class Lanedet(Node):
    ...
    def __init__(self):
        ...
        self.leftdetection_publisher = self.create_publisher(LaneParams, '/detection/lane/leftlanedetection', 10)
        self.rightdetection_publisher = self.create_publisher(LaneParams, '/detection/lane/rightlanedetection', 10)
        self.pub_projected_markings = self.create_publisher(LaneMarkingProjectedArrayBoth, '/detection/lane/lane_markings_projected', 10)
    ...
    def listener_callback(self, camera_img):
        ...
        lane_img = cv2.line(lane_img, (460,460),(460,480),(0,255,0),3)
        ...
        if leftparam.size == 0:
            ...
            left_detection.c = leftparam[2]-0.2
            for lane in egoleft:
                lmp = LaneMarkingProjected()
                lmp.x = lane[0]
                lmp.y = lane[1]
