...
class Yolo3dDetector(Node):
    ...
    def __init__(self):
        ...
        self.declare_parameter("yolo_2d_topic", "/detection/object/yolo2dbboxes")
        ...
        self.detection_publisher = self.create_publisher(Detection3DArray, '/detection/object/yolo3ddetection', 10)

        # Create an Image publisher for the results
        self.result_publisher = self.create_publisher(Image,'/detection/object/image3d_raw',10)
        self.bbox_publish = self.create_publisher(MarkerArray, "/detection/object/det3dbboxes", 10)
    ...
    def callback(self, image_msg, bbox2ds_msg):
        ...
        for i, obj in enumerate(objects):
            marker_msg = self.object_to_marker(obj, frame_id='base_link', marker_id=i, duration=1)
