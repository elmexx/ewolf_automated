...
class Video2Img(Node):
    ...
    def __init__(self):
        ...
        self.declare_parameter("publish_topic", 'camera/color/image_raw')
    ...
    def timer_callback(self):
        ...
        if ret:
            resize_frame = cv2.resize(frame, (self.img_width,self.img_height), interpolation = cv2.INTER_AREA) #width 848, height 480
