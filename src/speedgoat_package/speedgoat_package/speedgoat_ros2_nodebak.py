...
class Speedgoat(Node):
    def __init__(self):
        ...
        left_sub = Subscriber(self, LaneParams, '/detection/lane/leftlanedetection')
        right_sub = Subscriber(self, LaneParams, '/detection/lane/rightlanedetection')
    ...
    def callback(self, left_sub, right_sub):
        ...
        self.get_logger().info('control angle: "%f"' % control_angle)
