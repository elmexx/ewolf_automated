...
public:
     ...
     */
    ScalaSDKPublisher() : Node("scala_decoder_sdk_publisher_2") {
        try {
            parseParameters();
            ...
            mPublisher = this->create_publisher<sensor_msgs::msg::PointCloud2>("/scala_decoder_sdk_points_2", 25);
        ...
        try {
            ...
            if (package) {
                ...
                if (pclVecFrame) {
                    ...
                    pclVecFrame->header.frame_id = "lidar_right";
