...
class TrtYOLO(object):
    ...
    def _load_engine(self):
        ...
        #TRTbin = '/home/jetson/ros2_ws/src/yolo_trt_ros2/yolo_trt_ros2/yolo/%s.trt' % self.model
        TRTbin = os.getenv("HOME")+ '/ros2_ws/src/yolo_trt_ros2/yolo_trt_ros2/yolo/%s.trt' % self.model
