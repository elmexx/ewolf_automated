...
class YoloDetector(Node):
    ...
    def __init__(self):
        ...
        self.detection_publisher = self.create_publisher(Detection2DArray, '/detection/object/yolo2ddetection', 10)
        self.bboxes_publisher = self.create_publisher(BoundingBoxes, '/detection/object/yolo2dbboxes', 10)
        # Create an Image publisher for the results
        self.result_publisher = self.create_publisher(Image,'/detection/object/image_raw',10)
